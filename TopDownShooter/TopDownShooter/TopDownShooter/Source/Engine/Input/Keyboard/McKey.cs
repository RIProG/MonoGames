...
namespace TopDownShooter
{
    public class McKey
    {
        ...
        public void MakePrint(string KEY)
        {
            ...
            if(KEY == "A" || KEY == "B" || KEY == "C" || KEY == "D" || KEY == "E" || KEY == "F" || KEY == "G" || KEY == "H" || KEY == "I" || KEY == "J" || KEY == "K" || KEY == "L" || KEY == "M" || KEY == "N" || KEY == "O" || KEY == "P" || KEY == "Q" || KEY == "R" || KEY == "S" || KEY == "T" || KEY == "U" || KEY == "V" || KEY == "W" || KEY == "X" || KEY == "Y" || KEY == "Z" || KEY == "Å" || KEY == "Ä" || KEY == "Ö")
            {
                tempStr = KEY;
            }
            if(KEY == "Space")
